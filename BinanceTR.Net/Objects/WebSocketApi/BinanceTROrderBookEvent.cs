...
namespace Binance.Net.Objects.Spot.MarketData
{
    ...
    /// Stream order book
    /// </summary>
    public class BinanceTROrderBookEvent : BinanceTROrderBook, IBinanceEventOrderBook
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("b")]
        internal IEnumerable<BinanceTROrderBookEntry> BidsStream { set => Bids = value; }

        /// <summary>
        /// Setter for asks (needed forJson.Net)
        /// </summary>
        [JsonProperty("a")]
        internal IEnumerable<BinanceTROrderBookEntry> AsksStream { set => Asks = value; }
    }
}
